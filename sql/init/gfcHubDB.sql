-- Canonical bootstrap SQL for Docker/manual `psql` init.
-- Prisma replays the same statements in `prisma/migrations/20251218224843_init_gfchub_v2/migration.sql`; update both when changing the base schema.
