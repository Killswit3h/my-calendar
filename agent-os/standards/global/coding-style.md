...
- **Shared Linter and Formatter**: Agree on and use a common linter and formatting configuration (e.g., ESLint, Prettier) across both frontend and backend code to ensure a unified style and reduce merge conflicts.
