...
- **State and Navigation Consistency**: Ensure that components handling different phases of the UI maintain a consistent pattern for passing navigation state and context, making it easier to manage transitions between project views.
