...
export default function ImportCustomersPage() {
  ...
  const [result, setResult] = useState<null | { total: number; inserted: number; skipped: number; errors: number }>(null);
  ...
  return (
    <main className="cal-shell">
      ...
      <p className="muted-sm">Upload QuickBooks CSV. Headers accepted: Display Name, Company, or Customer.</p>
