    ...
    phases: [
      {
        ...
        items: [
          { id: 'phase-1-1', payItem: '550-5-125', description: 'Handrail Fabrication', quantity: 500, installedQty: 260 },
          { id: 'phase-1-2', payItem: '550-7-330', description: 'Handrail Installation', quantity: 500, installedQty: 240 },
        ],
      },
      {
        id: 'phase-2',
        ...
        items: [
          { id: 'phase-2-1', payItem: '550-5-125', description: 'Handrail Fabrication', quantity: 320, installedQty: 120 },
          { id: 'phase-2-2', payItem: '550-7-330', description: 'Handrail Installation', quantity: 320, installedQty: 110 },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        items: [
          { id: 'phase-1-1', payItem: '536-8-114', description: 'Guardrail Removal', quantity: 1200, installedQty: 720 },
          { id: 'phase-1-2', payItem: '536-8-432', description: 'Guardrail Installation', quantity: 1400, installedQty: 880 },
        ],
      },
    ],
  },
    ...
    <section className="qty-editor">
      ...
      <header className="qty-header">
        ...
        <div className="qty-actions">
          ...
          <button type="button" className="btn primary" onClick={handleSave} disabled={saving || !eventId || (!!lines.length && lines.every(line => !line.payItemId)) || missingRequired}>
